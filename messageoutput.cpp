...
void MessageOutput::Printf(int stream, const char *format, ...)
{
    ...
    std::cout<< "Printf Debug1" << std::endl;
	va_start(marker, format);
    std::cout<< "Printf Debug2" << std::endl;
	vsnprintf(localvsbuffer, 1023, format, marker);
    std::cout<< "Printf Debug3" << std::endl;
	va_end(marker);
    std::cout<< "Printf Debug4" << std::endl;

    if(streams[stream] != NULL){
        std::cout<< "Printf Debug5" << std::endl;
        streams[stream]->print(localvsbuffer);
        std::cout<< "Printf Debug6" << std::endl;
    }
    if(streams[ALL_STREAM] != NULL){
        std::cout<< "Printf Debug7" << std::endl;
        streams[ALL_STREAM]->print(localvsbuffer);
        std::cout<< "Printf Debug8" << std::endl;
    }
    std::cout<< "Printf Debug9" << std::endl;
}
